...
# --- ZIYO-AI KENGAYTIRILGAN INTELLEKTUAL BAZASI ---
async def generate_ziyo_response(prompt: str) -> str:
    ...
    # Umumiy savollar uchun universal chuqur tahlil
    else:
...
# --- ZAMONAVIY TO'LIQ EKRANLI DIZAYN (CHATGPT USLUBIDA) ---
